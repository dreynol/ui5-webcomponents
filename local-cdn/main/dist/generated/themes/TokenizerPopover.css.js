...
const styleData = { packageName: "@ui5/webcomponents", fileName: "themes/TokenizerPopover.css.ts", content: `[ui5-responsive-popover]::part(header),[ui5-responsive-popover]::part(content){padding:0}#ui5-tokenizer-dialog-confirm-btn{height:100%;min-width:4rem}[ui5-responsive-popover]{margin-top:var(--_ui5-v1-24-3_tokenizer-popover_offset);margin-inline-start:calc(-1 * var(--_ui5-v1-24-3_tokenizer_padding))}
` };
